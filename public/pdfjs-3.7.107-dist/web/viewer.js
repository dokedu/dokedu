            ...
            for (const { dest, items } of levelData.items) {
              ...
              if (Array.isArray(explicitDest)) {
                ...
                if (
                  ...
                  (!pageNumberToDestHash.has(pageNumber) || currentNesting > pageNumberNesting.get(pageNumber))
                ) {
    ...
    /***/ (__unused_webpack_module, exports, __webpack_require__) => {
      ...
      class PDFThumbnailViewer {
        constructor({ container, eventBus, linkService, renderingQueue, l10n, pageColors }) {
          ...
          if (
            this.pageColors &&
            !(CSS.supports("color", this.pageColors.background) && CSS.supports("color", this.pageColors.foreground))
          ) {
      ...
      class PDFViewer {
        ...
        scrollPageIntoView({
          ...
          switch (destArray[1].name) {
            ...
            case "FitR":
              ...
              heightScale =
                (this.container.clientHeight - vPadding) / height / _pdfjsLib.PixelsPerInch.PDF_TO_CSS_UNITS;
        ...
        update() {
          ...
          const isSimpleLayout =
            this._spreadMode === _ui_utils.SpreadMode.NONE &&
            (this._scrollMode === _ui_utils.ScrollMode.PAGE || this._scrollMode === _ui_utils.ScrollMode.VERTICAL);
        ...
        forceRendering(currentlyVisiblePages) {
          ...
          const preRenderExtra =
            this._spreadMode !== _ui_utils.SpreadMode.NONE && this._scrollMode !== _ui_utils.ScrollMode.HORIZONTAL;
          ...
          div.addEventListener("copy", (event) => {
            if (!this.#enablePermissions) {
              ...
              event.clipboardData.setData(
                "text/plain",
                (0, _ui_utils.removeNullCharacters)((0, _pdfjsLib.normalizeUnicode)(selection.toString())),
              );
            }
            event.preventDefault();
            event.stopPropagation();
