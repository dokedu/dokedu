...
<template>
  <DialogRoot v-model:open="open">
    <DialogTrigger
      class="transition-color group relative inline-flex h-fit select-none items-center justify-center gap-2 overflow-hidden rounded-lg border border-stone-200 px-4 py-1.5 text-stone-700 shadow-sm hover:bg-stone-100 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-stone-950"
    >
        ...
        <DialogDescription class="text-sm">
          <div class="flex w-full items-center justify-center">
            <label
              ref="dropZoneRef"
              for="dropzone-file"
              class="flex h-64 w-full cursor-pointer flex-col items-center justify-center rounded-lg border-2 border-dashed border-stone-300 bg-stone-50 hover:bg-stone-100"
            >
              <div class="flex flex-col items-center justify-center pb-6 pt-5">
                <svg
                  class="mb-4 h-8 w-8 text-stone-500"
                  aria-hidden="true"
                ...
                <p class="mb-2 text-sm text-stone-500">Your table must comply with the following format:</p>
                <table class="select-none divide-y divide-stone-200 border border-stone-200 text-stone-500">
                  <thead>
                    <tr class="divide-x divide-stone-200 font-medium text-stone-500">
                ...
                <p class="text-xs text-stone-500">XLXS</p>
              </div>
