<template>
  ...
  >
    ...
    <div
      ref="menu"
      v-if="open"
      class="absolute -top-[1px] right-8 w-52 rounded-md border border-stone-200 bg-white shadow-md"
    >
      <div class="flex flex-col border-b p-1">
        <div
          class="flex items-center justify-between gap-2 rounded-md px-3 py-1 text-sm text-stone-700 hover:bg-stone-100"
          @click="update(0)"
        >
