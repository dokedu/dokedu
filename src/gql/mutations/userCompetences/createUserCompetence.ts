...
export type CreateUserCompetenceMutation = { __typename?: "Mutation" } & {
  createUserCompetence: { __typename?: "UserCompetence" } & Pick<Types.UserCompetence, "id" | "level">
}
...
export function useCreateUserCompetenceMutation() {
  return Urql.useMutation<CreateUserCompetenceMutation, CreateUserCompetenceMutationVariables>(
    CreateUserCompetenceDocument
  )
}
