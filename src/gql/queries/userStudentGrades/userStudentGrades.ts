...
export function useUserStudentGradesQuery(
  options: Omit<Urql.UseQueryArgs<never, UserStudentGradesQueryVariables>, "query">
) {
  return Urql.useQuery<UserStudentGradesQuery, UserStudentGradesQueryVariables>({
