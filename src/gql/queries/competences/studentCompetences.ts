...
export function useStudentCompetencesQuery(
  options: Omit<Urql.UseQueryArgs<never, StudentCompetencesQueryVariables>, "query">
) {
  return Urql.useQuery<StudentCompetencesQuery, StudentCompetencesQueryVariables>({
    query: StudentCompetencesDocument,
    ...options
  })
}
