...
export type StudentCompetenceQuery = (
  ...
  & { competence: (
    ...
    & Pick<Types.Competence, 'id' | 'name'>
    & { parents: Array<(
      { __typename?: 'Competence' }
      & Pick<Types.Competence, 'id' | 'name'>
    )>, competences: Array<Types.Maybe<(
      { __typename?: 'Competence' }
      & Pick<Types.Competence, 'type' | 'id' | 'name' | 'grades'>
      & { parents: Array<(
        { __typename?: 'Competence' }
        & Pick<Types.Competence, 'id' | 'name'>
      ...
      )>, userCompetences: Array<Types.Maybe<(
        { __typename?: 'UserCompetence' }
        & Pick<Types.UserCompetence, 'id' | 'level' | 'createdAt'>
        & { entry?: Types.Maybe<(
          { __typename?: 'Entry' }
          & Pick<Types.Entry, 'id'>
