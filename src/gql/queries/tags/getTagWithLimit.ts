...
export function useGetTagWithLimitQuery(
  options: Omit<Urql.UseQueryArgs<never, GetTagWithLimitQueryVariables>, "query">
) {
  return Urql.useQuery<GetTagWithLimitQuery, GetTagWithLimitQueryVariables>({
