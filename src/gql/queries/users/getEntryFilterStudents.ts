...
export type GetEntryFilterStudentsQuery = { __typename?: "Query" } & {
...
export function useGetEntryFilterStudentsQuery(
  options: Omit<Urql.UseQueryArgs<never, GetEntryFilterStudentsQueryVariables>, "query">
) {
  return Urql.useQuery<GetEntryFilterStudentsQuery, GetEntryFilterStudentsQueryVariables>({
    query: GetEntryFilterStudentsDocument,
    ...options
  })
}
