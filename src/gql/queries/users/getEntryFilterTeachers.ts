...
export type GetEntryFilterTeachersQuery = { __typename?: "Query" } & {
...
export function useGetEntryFilterTeachersQuery(
  options: Omit<Urql.UseQueryArgs<never, GetEntryFilterTeachersQueryVariables>, "query">
) {
  return Urql.useQuery<GetEntryFilterTeachersQuery, GetEntryFilterTeachersQueryVariables>({
    query: GetEntryFilterTeachersDocument,
    ...options
  })
}
