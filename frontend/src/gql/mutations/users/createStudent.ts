...
export type CreateStudentMutation = { __typename?: 'Mutation', createStudent: { __typename?: 'User', id: string, firstName: string, lastName: string, student?: { __typename?: 'UserStudent', id: string, birthday?: never | null, grade: number, leftAt?: never | null, joinedAt?: never | null } | null } };
