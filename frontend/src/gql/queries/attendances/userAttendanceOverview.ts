...
export type UserAttendanceOverviewQuery = { __typename?: 'Query', userAttendanceOverview: Array<{ __typename?: 'UserAttendance', id: string, date: never, state: Types.UserAttendanceState, user: { __typename?: 'User', id: string, firstName: string, lastName: string } }> };
