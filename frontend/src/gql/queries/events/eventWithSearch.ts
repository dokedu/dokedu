...
export type EventWithSearchQuery = { __typename?: 'Query', events: { __typename?: 'EventConnection', pageInfo: { __typename?: 'PageInfo', hasNextPage: boolean, hasPreviousPage: boolean }, edges?: Array<{ __typename?: 'Event', id: string, title: string, body?: string | null, createdAt: never, startsAt: never, endsAt: never } | null> | null } };
